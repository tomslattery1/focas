...
const slides = [
  ...
  },
  {
    id: 2,
    icon: Eye,
    title: 'Monitor compliance at a glance',
    description: 'See your child\'s device status with our simple traffic-light system. Green means they\'re staying focused!',
  ...
  },
  {
    ...
    description: 'Your child uses their NFC tag to unlock Study Mode at home. If they need a backup, you can generate a temporary code from your dashboard.',
    color: 'bg-primary/10',
    iconColor: 'text-primary',
  },
  {
