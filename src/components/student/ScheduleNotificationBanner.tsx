...
export const ScheduleNotificationBanner = ({
  ...
  const { isNfcSupported, isScanning, startNfcScan } = useNfcActivation(onActivate);
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-foreground mb-1">
                    {isScanning ? 'Waiting for NFC tag...' : 'Study Mode is ready!'}
                  </h3>
                  <p className="text-sm text-muted-foreground mb-3">
                    {isScanning 
                      ? 'Hold your phone near the classroom NFC tag to start.'
