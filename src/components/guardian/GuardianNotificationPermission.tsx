...
interface GuardianNotificationPermissionProps {
  onComplete: (granted: boolean) => void;
}

const GuardianNotificationPermission = ({ onComplete }: GuardianNotificationPermissionProps) => {
  ...
  const handleAllow = () => {
    localStorage.setItem('guardianNotificationPermissionGranted', 'true');
    onComplete(true);
  };

  const handleDontAllow = () => {
    localStorage.setItem('guardianNotificationPermissionGranted', 'false');
    onComplete(false);
  };
          ...
          >
            ...
            <div className="w-full max-w-sm space-y-3 mb-12">
              ...
              <div className="flex items-center gap-3 p-3 rounded-xl bg-muted/50">
                ...
                <span className="text-sm text-foreground">Emergency unlock requests</span>
              </div>
            </div>
...
export default GuardianNotificationPermission;
